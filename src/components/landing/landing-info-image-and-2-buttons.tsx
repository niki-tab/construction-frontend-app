...
export default function LandingInfoImageAnd2ButtonsContainer({ lang, maintitleValue, secondaryTitleValue, imagePath}:{ lang: string, maintitleValue: string, secondaryTitleValue: string, imagePath: string; }){
    ...
    return (
            ...
            <div className="flex-auto w-2/4 px-8 ml-8">
                <h1 className="font-mono font-bold text-4xl md:text-5xl">Encuentra encargos de talleres artesanales y afrontadlos conjuntamente</h1>
                <h2 className="font-mono font-bold text-3xl md:text-4xl mt-6">De artesano a artesano</h2>
                ...
                <div className="flex w-full pt-8">
                    <div className="flex-auto w-2/4">
                        <Link href={`/${lang}/subcontratistas`}><Button className="w-3/4 mx-auto bg-primary-brand-color hover:bg-secondary-brand-color">Buscar contratos</Button></Link>
                    </div>
                    <div className="flex-auto w-2/4">
                        <Link href={`/${lang}/contratistas`}><Button className="w-3/4 mx-auto bg-secondary-brand-color hover:bg-primary-brand-color">Publicar contratos</Button></Link>
                    </div>
                </div>
