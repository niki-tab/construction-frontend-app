...
export default function Footer({ lang }:{ lang: string; }){
    ...
    <div className="absolute inset-x-0 bottom-0 h-48 bg-neutral-300 grid grid-cols-4 gap-4">
        ...
        <div className="text-center">
            ...
            <p className="text-base font-mono pt-2 text-left ml-28"><Link href={`/${lang}/subcontratistas`}>Para Subcontratistas</Link></p>
            <p className="text-base font-mono text-left ml-28"><Link href={`/${lang}/contratistas`}>Para Para Contratistas</Link></p>
        </div>
        <div className="text-center">
