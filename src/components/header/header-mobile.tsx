...
export default function HeaderMobile ({ lang }:{ lang: string; }){
    ...
    return (
        ...
        <div className="h-20 w-full bg-white block md:hidden align-middle border-t-0 border-l-0 border-r-0 border-b-2 border-solid border-corporate-blue p-4 z-10">
